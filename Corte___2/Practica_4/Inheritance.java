...
public class Inheritance {
    public static void main(String[] args) {
        Employee employee1 = new Employee(1, 3000.5, "Alex", 'M', 32, "Facatativa");
        System.out.println(employee1);
        Employee employee2 = new Employee(2, 3450.20, "Alicia", 'F', 41, "Madrid");
        System.out.println(employee2);
        
        var fecha = new Date();
        
        Cliente cliente1 = new Cliente(fecha, true, "Mauro", 'M', 46, "Bogota");
